...
async function main(){
    ...
    //F: Face, T: Triangle
    cubeVertices = [//0.0, 2.0, 0.0, -2.0, 0.0, 0.0,//F1_T1_X,  F1_T1_Y,  F1_T1_Z,  F1_T2_X,  F1_T2_Y,  F1_T2_Z,   //this row for the face z = 1.0
                    //0.0, 0.0, 2.0, 0.0, -2.0, 0.0,//F2_T1_X,  F2_T1_Y,  F2_T1_Z,  F2_T2_X,  F2_T2_Y,  F2_T2_Z,   //this row for the face x = 1.0
                    //0.0, 0.0, 2.0, 2.0, 0.0, 0.0,//F3_T1_X,  F3_T1_Y,  F3_T1_Z,  F3_T2_X,  F3_T2_Y,  F3_T2_Z,   //this row for the face y = 1.0
                    //0.0, 0.0, 2.0, 0.0, 2.0, 0.0,//F4_T1_X,  F4_T1_Y,  F4_T1_Z,  F4_T2_X,  F4_T2_Y,  F4_T2_Z,   //this row for the face x = -1.0
                    //0.0, 0.0, 2.0, -2.0, 0.0, 0.0,//F5_T1_X,  F5_T1_Y,  F5_T1_Z,  F5_T2_X,  F5_T2_Y,  F5_T2_Z,   //this row for the face y = -1.0
                    //0.0, 2.0, 0.0, 2.0, 0.0, 0.0//F6_T1_X,  F6_T1_Y,  F6_T1_Z,  F6_T2_X,  F6_T2_Y,  F6_T2_Z,   //this row for the face z = -1.0
...
function draw(){
    ...
    mdlMatrix.translate(-0.5, 7.0, 0.0);
    ...
    mdlMatrix.scale(200, 10, 200);
    mdlMatrix.translate(moveDistance + 0.5, -7.0, 0.6);
    mdlMatrix.scale(0.02, 0.4, 0.02);
